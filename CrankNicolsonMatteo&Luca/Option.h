...
namespace m2 {
    class Option {
    protected:
        int call_put_; // 0 for call, 1 for put
        int american_; // 0 for European, 1 for American
    ...
    public:
        ...
        // Getter Functions
        int getCallPut() const { return call_put_; }
        int getAmerican() const { return american_; }
